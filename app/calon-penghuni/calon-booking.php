                  ...
                  <div class="card">
                    ...
                    <div class="d-flex flex-column card-body">
                      ...
                      <div class="btn-group mt-auto" role="group" aria-label="Basic example">
                        <button name="view" value="view" id="<?php echo $data_kamar['id_kamar']; ?>" class="btn btn-outline-primary view_data">Lihat Detail</button>
                        <button name="view" value="view" id="<?php echo $data_kamar['id_kamar']; ?>" class="btn btn-outline-success booking_kamar">Booking</button>
                      </div>
                    </div>
                  </div>
                </div>
