...
<body id="page-top">
              ...
              <div class="card-body">
                ...
                <div class="container-fluid pr-3">
                  <img src="../../img/<?php
                                      ...
                                      ?>" alt="<?php echo $dataPembayaran['tanggal_pembayaran']; ?>" class="img-thumbnail mx-auto d-block mb-3 rounded" width="300px">
                    ...
                    <div class="table-respomsive pr-3">
                      ...
                      <form action="../../actions/process-insert.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <input value="<?php echo ($dataPembayaran2['harga_total'] + $totalDenda); ?>" type="hidden" class="form-control" id="nominal" name="nominal" aria-describedby="nominal" placeholder="Masukkan nominal pembayaran" required>
                        </div>
                        <div class="form-group">
                          <input value="2" type="hidden" class="form-control" id="status" name="status" aria-describedby="status" placeholder="Masukkan nominal pembayaran" required>
                        </div>
                        <div class="form-group">
                          <input value="<?php echo $dataPembayaran2['id_menghuni'] ?>" type="hidden" class="form-control" id="menghuni" name="menghuni" aria-describedby="nominal" placeholder="Masukkan nominal pembayaran" required>
                        </div>
                        <div class="form-group">
                          <label for="tanggal">Tanggal Pembayaran</label>
                          <input value="<?php echo $dataPembayaran2['tanggal_sekarang'] ?>" type="date" class="form-control" id="tanggal" name="tanggal" aria-describedby="nominal" placeholder="Masukkan nominal pembayaran" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="submitPembayaran" class="btn btn-primary" onclick="return confirm('Anda yakin ingin melakukan pembayaran? Pastikan data yang diinputkan benar');">Bayar
                          Kamar</button>
                      </form>
                    </div>
                  </div>
  ...
  <!-- Booking modal -->
  <div class="modal fade" id="bookingKamar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
