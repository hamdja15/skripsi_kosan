...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="penghuni-settings-profil.php">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="penghuni-settings-rubah-password.php">
            ...
            <div class="card col-12">
              <div class="card-body">
                ...
                <form action="../../actions/process-update.php" class="needs-validation" method="POST" novalidate>
                  ...
                  <button type="submit" name="rubah_password_penghuni" class="btn btn-primary btn-block" onclick="return confirm('Anda yakin ingin merubah password?');">Rubah password</button>
                </form>
              </div>
            </div>
          </div>
